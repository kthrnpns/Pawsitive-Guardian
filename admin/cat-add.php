            ...
            <form class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="vaccinated">
                                <label class="form-check-label" for="vaccinated">Vaccinated</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="spayedNeutered">
                                <label class="form-check-label" for="spayedNeutered">Spayed/Neutered</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="microchipped">
                                <label class="form-check-label" for="microchipped">Microchipped</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="dewormed">
                                <label class="form-check-label" for="dewormed">Dewormed</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="fleaTreated">
                                <label class="form-check-label" for="fleaTreated">Flea-treated</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="specialNeeds">
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="independent">
                                <label class="form-check-label" for="independent">Independent</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="goodWithCats">
                                <label class="form-check-label" for="goodWithCats">Good with Cats</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="goodWithDogs">
                                <label class="form-check-label" for="goodWithDogs">Good with Dogs</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="goodWithKids">
                                <label class="form-check-label" for="goodWithKids">Good with Kids</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="vocal">
                                <label class="form-check-label" for="vocal">Vocal</label>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="lapCat">
